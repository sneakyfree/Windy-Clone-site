  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-windy-darker/95 backdrop-blur-lg border-b border-windy-pink/10 shadow-lg shadow-black/20'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <a href="#hero" className="flex items-center space-x-2 group">
            ...
            <span className="text-xl font-bold gradient-text">Windy Clone</span>
          </a>
          ...
          <button
            ...
            className="md:hidden text-gray-300 hover:text-windy-pink"
          >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-windy-pink/10 py-4 bg-windy-darker/95 backdrop-blur-lg"
            >
              {navLinks.map((link) => (
                <a
                  key={link.name}
